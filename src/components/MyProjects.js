...
const Img = styled.img`
  ...
  margin-bottom: 4%;
  border-radius: 8px;
  box-shadow: 2px 2px 5px #cccccc, -3px -3px 6px #cccccc;
`;
      ...
      <Container>
        ...
        <SliderContainer>
          <Swiper
            ...
            <SwiperSlide>
              <Img alt="Image" src={AnimusicImg} srcSet=""></Img>
              <Head>Ani-Oke</Head>
              <Description>
                Still under development, I am developing this using react,
                featuring lyrics in romanji for all anime
                openings/endings/songs. Developed as a learning project.
              </Description>
              <BtnContainer>
                <A
                  href="https://github.com/Malay-dev/Anime_Spotify.git"
                  target="_blank"
                  rel="noopener noreferrer">
                  <GithubBtn>
                    <svg
                ...
                <A
                  href="https://malay-dev.github.io/Anime_Spotify/"
                  target="_blank"
                  rel="noopener noreferrer">
                  <LinkBtn>
                    <svg
